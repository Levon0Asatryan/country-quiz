    ...
    <div className="flex flex-col items-center justify-center h-90 md:h-95 select-none">
      ...
      <div className="p-4 md:p-8 min-h-400 md:min-h-515 w-96 md:w-standart bg-white rounded-3xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-72 z-10 ">
        <div className="flex flex-col items-center h-full w-ful">
          ...
          <div className="mt-8 md:mt-16 font-bold leading-11 text-blue text-5xl h-20 flex justify-center items-center">
            Results
          </div>
          <div className=" font-normal leading-11 text-lg text-blue h-8 md:h-14 flex justify-center items-center">
            You got
          ...
          <div
            className="cursor-pointer mt-8 md:mt-16 w-52 h-16 border-2 border-blue flex justify-center items-center font-semibold text-lg text-blue rounded-xl"
            onClick={tryAgain}
          >
            Try again
          </div>
